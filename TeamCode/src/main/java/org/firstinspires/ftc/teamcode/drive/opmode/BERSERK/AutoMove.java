            ...
            switch (currentMode) {
                case DRIVER_CONTROL:
                    ...
                    if (gamepad1.a) {
                        ...
                        Pose2d powershotpose = new Pose2d(-5.0,-12, Math.toRadians(0.0));
                        drive.setPoseEstimate(powershotpose);
                        Trajectory autoPowershot = drive.trajectoryBuilder(poseEstimate)
                        ...
                        drive.followTrajectoryAsync(autoPowershot);
