package org.firstinspires.ftc.teamcode.drive.opmode.velo;
...
public class TuningController {
    ...
    public static double TESTING_MAX_SPEED = 0.4 * MOTOR_MAX_RPM;
    public static double TESTING_MIN_SPEED = 0.1 * MOTOR_MAX_RPM;
