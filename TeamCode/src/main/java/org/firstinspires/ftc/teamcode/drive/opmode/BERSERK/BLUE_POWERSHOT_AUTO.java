...
public class BLUE_POWERSHOT_AUTO extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory A1 = drive.trajectoryBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(-5.0, 11.0, Math.toRadians(0.0)), Math.toRadians(0.0))
                .build();

        Trajectory A1a = drive.trajectoryBuilder(A1.end())
                .splineToLinearHeading(new Pose2d(-5.0, 13.0, Math.toRadians(8.0)), Math.toRadians(0.0))
                .build();

        Trajectory A1b = drive.trajectoryBuilder(A1a.end())
                .splineToLinearHeading(new Pose2d(-5.0, 14.0, Math.toRadians(15.0)), Math.toRadians(0.0))
                .build();
        ...
        Trajectory B6 = drive.trajectoryBuilder(B5.end())
                .splineToLinearHeading( new Pose2d(18.0, 39.0, Math.toRadians(-90.0)), Math.toRadians(0.0))
                .build();
        ...
        Trajectory C1 = drive.trajectoryBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-41,35, Math.toRadians(3.0)))
     ...
     //           .build();
        ...
        Trajectory C5 = drive.trajectoryBuilder(C3.end())
                ...
                //Approach Zone C
                .splineToSplineHeading( new Pose2d(39.0, 50.0, Math.toRadians(0)), Math.toRadians(0),
                        new MinVelocityConstraint(Arrays.asList(
                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
        ...
        Trajectory C6 = drive.trajectoryBuilder(C5.end())
                .splineToSplineHeading( new Pose2d(44.0, 53.0, Math.toRadians(-45.0)), Math.toRadians(0),
                        new MinVelocityConstraint(Arrays.asList(
                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                new MecanumVelocityConstraint(70, DriveConstants.TRACK_WIDTH)
                        )
        ...
        Trajectory C7 = drive.trajectoryBuilder(C6.end(),true)
                .splineToLinearHeading( new Pose2d(15.0,16.0, Math.toRadians(0.0)), Math.toRadians(180.0),
                        new MinVelocityConstraint(Arrays.asList(
                                new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                new MecanumVelocityConstraint(70, DriveConstants.TRACK_WIDTH)
                        )
